# Agent Instructions for ErrorTaxonomy

## Project Context
ErrorTaxonomy is an open source Standardized error codes and classification for agent failures.

## Repository Layout
- `src/aumai_error_taxonomy/` — package source
